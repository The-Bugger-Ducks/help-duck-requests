...
public interface TicketRepository extends MongoRepository<Ticket, String> {
  ...
  Page<Ticket> filterAllByLowPriority(Pageable pageable, PriorityLevelEnum priority);

  @Query("{'priorityLevel': 'medium'}")
  Page<Ticket> filterAllByMediumPriority(Pageable pageable, PriorityLevelEnum priority);

  @Query("{'priorityLevel': 'high'}")
  Page<Ticket> filterAllByHighPriority(Pageable pageable, PriorityLevelEnum priority);
